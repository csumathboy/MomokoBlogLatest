...
import { getPostsByTagName } from '@/lib/api';
import PostList from '@/components/PostList';
 

export default async function Tag({ params }) {
  const posts = await getPostsByTagName(params.slug[0]);
    return (
        <main id="main" className="site-main clearfix">
		<div className="container">
			<div id="primary" className="content-area clearfix" role="main">
            <header className="page-header clearfix"><h1 className="page-title">标签：{decodeURI(params.slug[0])}</h1></header>
