...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MomokoBlog.Classifications.Classification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MomokoBlog.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MomokoBlog.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MomokoBlog.Posts.PostTag", b =>
                {
            ...
            modelBuilder.Entity("MomokoBlog.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MomokoBlog.Posts.Post", b =>
                {
                    b.HasOne("MomokoBlog.Classifications.Classification", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MomokoBlog.Posts.PostTag", b =>
                {
                    b.HasOne("MomokoBlog.Posts.Post", null)
                        .WithMany("PostTags")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MomokoBlog.Tags.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
